...
The backend runs every idempotent SQL migration at startup and keeps Participant, session, policy, Gem, privileged-role, moderation, Source Feed, and audit state in SQLite.
